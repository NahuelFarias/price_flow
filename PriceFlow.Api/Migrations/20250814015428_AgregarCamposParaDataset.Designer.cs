...
namespace PriceFlow.Api.Migrations
{
    ...
    [Migration("20250814015428_AgregarCamposParaDataset")]
    partial class AgregarCamposParaDataset
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PriceFlow.Api.Domain.Entities.Venta", b =>
                {
                    ...
                    b.Property<string>("TemporadaEspecial")
                        .IsRequired()
                        .HasColumnType("varchar(255)");
            ...
            modelBuilder.Entity("PriceFlow.Api.Domain.Entities.Venta", b =>
                {
                    b.HasOne("PriceFlow.Api.Domain.Entities.Precio", "PrecioDeLista")
                        .WithMany()
                        .HasForeignKey("PrecioId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("PrecioDeLista");
                });
